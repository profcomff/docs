...
0) Перед использованием проверить, есть ли доступ к EasyCode. Доcтуп можно запросить по [ссылке](https://forms.yandex.ru/u/65663f2784227c1f53dd8a15/)
1) В репозитории [dwh-pipelines](https://github.com/profcomff/dwh-pipelines) нажать на ссылку EasyCode. 
...
2) Генерация миграций в локальной базе данных
...
3) Разработка и дебаг эирфлоу тасков.
