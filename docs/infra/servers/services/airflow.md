...
Apache Airflow — программное обеспечение для создания, выполнения, мониторинга и оркестрации потоков операций по обработке данных. Основная особенность Airflow: для описания (разработки) процессов используется код на языке Python.
...
Используется это все для работы с данными, их обработки, переливаний из одной таблицы в другую и т.д.
...
Пайплайны лежат [в репозитории dwh-pipelines](https://github.com/profcomff/dwh-pipelines). Это то, что запускает Airflow для работы с данными.

[В репозитории dwh-definitions](https://github.com/profcomff/dwh-definitions) лежат схемы данных и миграции.
