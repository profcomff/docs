...
6. Проверить соответствие проекта стандартам PEP8, прогнать по коду black, isort
...
1. Собери БД
    ...
    make db
    ```
2. Заполни БД тестовыми данными, буквально по несколько строк
3. Сделай миграцию вверх
    ```bash
    alembic upgrade head
    ```
4. Добавь еще немного данных
5. Сделай миграцию вниз
    ```bash
    alembic downgrade head-9 # Вместо 9 поставить количество файлов миграций
    ```
> **Note**
> На добавление одной фичи должен быть __один__ файл миграций. Не надо делать несколько фич в одном файле или разбивать одну фичу на много миграций
...
После сливания ветки в `main` и тестирования со стороны коммьюнити, можно выкатывать фичу в прод.
